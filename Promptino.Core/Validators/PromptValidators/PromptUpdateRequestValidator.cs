...
public class PrormptUpdateRerquestValidator : AbstractValidator<PromptUpdateRequest>
{
    public PrormptUpdateRerquestValidator()
    {
        RuleFor(req => req.Id)
            .NotEmpty().WithMessage("آیدی پرامپت الزامی است")
            .Must(id => id != Guid.Empty)
            .WithMessage("آیدی وارد شده نامعتبر است");
